        ...
        <div className="relative mb-8">
          ...
          <div className="text-center">
            ...
            <div className="w-40 h-40 rounded-2xl mx-auto mb-6 flex flex-col items-center justify-center  gap-y-4 p-4 shadow-lg">
              <Image
                src="https://rb8rdqum7a.ufs.sh/f/vQo55KkBNOoCsQmL0qVEcNAJR8gZCLyjWB723H6mtDrpGVdb"
                width={250}
                height={250}
                alt="Wave Logo"
            ...
            <p className='text-gray-300 mb-4 text-sm md:text-lg lg:text-xl '>Veuillez payer le montant de 40 000 F CFA, en utilisant le QR Code ci-dessus</p>
