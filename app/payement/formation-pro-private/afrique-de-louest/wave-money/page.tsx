      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 max-w-xl w-full mx-4 relative shadow-2xl border border-white/20">
        ...
        <div className="relative mb-8">
          ...
          <div className="text-center">
            <Button
              onClick={() => window.open("https://pay.wave.com/m/M_sn_G2Wr-JkkZgll/c/sn/?amount=100000", "_blank")}
            >
              Payer
            </Button>
            <div className="w-40 h-40 rounded-2xl mx-auto mb-6 flex flex-col items-center justify-center  gap-y-4 p-4 shadow-lg">
              <Image
                src="https://rb8rdqum7a.ufs.sh/f/vQo55KkBNOoCfTxLRHBNheWFT570BjAXnyHcYIiZLpKotD3u"
                width={250}
                height={250}
                alt="Wave Logo"
            ...
            <p className='text-gray-300 mb-4 text-sm md:text-lg lg:text-xl '>Veuillez payer le montant de 100.000 F CFA, en utilisant le QR Code ci-dessus</p>
            <h2 className="text-1xl md:text-4xl font-bold mb-3 text-white">
              Confirmation de Paiement Wave
            </h2>
